# Noise Node for netscience.gml dataset
# Dataset for medium-large amount of nodes.
...
#print(rank)
print('\n')
print("Number of nodes in netscience dataset: ",len(G1.nodes),"Number of edges in netscience dataset: ", len(G1.edges))
print('\n')
