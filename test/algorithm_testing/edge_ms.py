# Testing for multiple labelled dataset using edge editing technique.

import sys
sys.path.append(r"..\..")
from src import helpers_ms
from src import edge_editing_ms
...
for i in range(0,3):
    for j in range(0,5):
        ...
        #print(i+1,j+1)
        G1,G2,X,Y,E = edge_editing_ms.edge_editing(k,l,i+1,j+1,1,r'..\..\data\karate.gml')
        Y = Y/(1024*1024)
        #print(X,Y)
        g.append(G2)
