# Noise Node for netscience2.gml dataset
# Dataset for large amount of nodes.
...
#print(rank)
print('\n')
print("Number of nodes in netscience2 dataset: ",len(G1.nodes),"Number of edges in netscience2 dataset: ", len(G1.edges))
print('\n')
